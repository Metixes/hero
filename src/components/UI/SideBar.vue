    ...
    <div class="user-statistics">
      ...
      <div class="user-level">
        <a-progress
          type="circle"
          :showInfo="false"
          :percent="store.state.user.userData.rating.rating * 10"
          :size="90"
          strokeLinecap="round"
          trailColor="#FFF"
          strokeColor="#FFF"
          ...
          direction="rtl"
        />
        <div class="user-level-data">
          <span class="user-level-data-number">{{
            store.state.user.userData.rating.rating
          }}</span>
          <span class="user-level-data-level">LEVEL</span>
        </div>
        <img
          width="30"
          height="40"
...
const tabValue = ref(store.getters["getResponseType"]);
...
const changeChatResponseType = (type) => store.commit("setChatResponseType", type);
